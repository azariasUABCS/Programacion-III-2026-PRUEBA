...
public class Colores {
    ...
    public static final Color BACKGROUND = new Color(222, 205, 245);
    public static final Color SHADOW_COLOR = new Color(0, 0, 0);
    
    public static final Color LOGIN_PANEL = new Color(42, 42, 121);
    ...
    public static final Color PROFILE_PANEL = new Color(191, 172, 200);
